...
import { uploadBuildingBlockBom } from "../../../api/ordersApi";

export function BuildingBlockBomStep({ orderId, onComplete, onCancel }: { orderId: number; onComplete: () => void; onCancel: () => void }) {
  ...
  const handleSubmit = async () => {
    ...
    setError(null);
    try {
      await uploadBuildingBlockBom(orderId, file);
      onComplete();
    } catch (e) {
  ...
  return (
    <div>
      <h3>Upload BUILDING_BLOCK BOM</h3>
